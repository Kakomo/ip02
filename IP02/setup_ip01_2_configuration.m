...
function [ Rm, Jm, Kt, Eff_m, Km, Kg, Eff_g, M, r_mp, Beq ] = setup_ip01_2_configuration( CART_TYPE, IP02_LOAD_TYPE, AMP_TYPE )
% Calculate useful conversion factors
calc_conversion_constants();
% Calculate IP01 or IP02 model parameters
[ Rm, Jm, Kt, Eff_m, Km, Kg, Eff_g, M, r_mp, Beq ] = calc_IP01_2_parameters( CART_TYPE, IP02_LOAD_TYPE, AMP_TYPE );
% end of 'setup_ip01_2_configuration( )'


%% Calculate the IP01 or IP02 model parameters 
function [ Rm, Jm, Kt, Eff_m, Km, Kg, Eff_g, M, r_mp, Beq ] = calc_IP01_2_parameters( CART_TYPE, IP02_LOAD_TYPE, AMP_TYPE )
