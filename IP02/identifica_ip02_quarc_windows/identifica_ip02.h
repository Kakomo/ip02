...
typedef struct {
  ...
  real_T Fcn1;                         /* '<S3>/Fcn1' */
  real_T LookUpTable;                  /* '<S3>/Look-Up Table' */
  ...
  real_T IP02ModeloExperimental;       /* '<Root>/IP02 Modelo Experimental' */
  real_T SwitchControl;                /* '<S2>/SwitchControl' */
  real_T Sum1;                         /* '<Root>/Sum1' */
  real_T Kp1;                          /* '<Root>/Kp1' */
  real_T AmplifierVoltageSaturation1;  /* '<Root>/Amplifier Voltage Saturation1' */
  real_T CheckMaximumAllowedPosition;  /* '<S4>/Check Maximum Allowed Position' */
  real_T CheckMinimumAllowedPosition;  /* '<S4>/Check Minimum Allowed Position' */
  real_T StepAmplitude;                /* '<Root>/Step Amplitude' */
  real_T StepAmplitude_d;              /* '<Root>/Step Amplitude ' */
  boolean_T Compare;                   /* '<S8>/Compare' */
  boolean_T Compare_m;                 /* '<S9>/Compare' */
...
typedef struct {
  real_T IP02ModeloExperimental_CSTATE;/* '<Root>/IP02 Modelo Experimental' */
...
/* State disabled  */
typedef struct {
  boolean_T IP02ModeloExperimental_CSTATE;/* '<Root>/IP02 Modelo Experimental' */
...
struct Parameters_identifica_ip02_ {
  ...
  real_T mtomm_Gain_f;                 /* Expression: 1e3
                                        * '<Root>/m to mm '
                                        */
  real_T IP02ModeloExperimental_A;     /* Computed Parameter: A
                                        * '<Root>/IP02 Modelo Experimental'
                                        */
  real_T IP02ModeloExperimental_C;     /* Computed Parameter: C
                                        * '<Root>/IP02 Modelo Experimental'
                                        */
  real_T Kp1_Gain;                     /* Expression: 420
                                        * '<Root>/Kp1'
                                        */
 ...
 * '<S2>'   : identifica_ip02/Manual Switch
 * '<S3>'   : identifica_ip02/Repeating Sequence
 * '<S4>'   : identifica_ip02/IP02/Cart Position Watchdog
 * '<S5>'   : identifica_ip02/IP02/Radians to Degrees
 * '<S6>'   : identifica_ip02/IP02/Cart Position Watchdog/Stop with Message
 * '<S7>'   : identifica_ip02/IP02/Cart Position Watchdog/Stop with Message1
 * '<S8>'   : identifica_ip02/IP02/Cart Position Watchdog/Stop with Message/Compare
 * '<S9>'   : identifica_ip02/IP02/Cart Position Watchdog/Stop with Message1/Compare
 */
